...
Router::scope('/', function (RouteBuilder $routes) {
     ...
     * and its action called 'index'.
     */
    $routes->connect('/', ['controller' => 'Home', 'action' => 'index']);

    $routes->connect('/resources/open/*', ['controller' => 'Resources', 'action' => 'open']);
    $routes->connect('/resources/create-resource', ['controller' => 'Resources', 'action' => 'add']);
    $routes->connect('/resources/edit-resource/*', ['controller' => 'Resources', 'action' => 'edit']);
    ...
    $routes->connect('/my-account/my-comments', ['controller' => 'MyAccount', 'action' => 'myComments']);
    $routes->connect('/my-account', ['controller' => 'MyAccount', 'action' => 'overview']);
