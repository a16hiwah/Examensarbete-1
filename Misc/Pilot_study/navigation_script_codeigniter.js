// ==UserScript==
// @name CodeIgniter navigation to use when measuring php execution time
// @namespace Violentmonkey Scripts
// @match http://localhost/Examensarbete/App/CodeIgniter/index.php/resources/*
// @grant none
// ==/UserScript==
...
window.onload = function ()
{
	...
	function navigatePages()
	{
		...
		if (active_page.search("open") > -1)
		{
			...
			window.open(
				"http://localhost/Examensarbete/App/CodeIgniter/index.php/resources/view/a",
				"_self"
			)
		}
		else
